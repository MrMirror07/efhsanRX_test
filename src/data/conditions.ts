...
export const CONDITIONS: Condition[] = [
  {
    ...
    h1: "Menopause and perimenopause care, by video, across New Jersey",
    eyebrow: "Menopause · New Jersey telehealth",
    intro:
      "Hot flashes at 3 a.m., sleep that falls apart, a mood you do not recognize. Perimenopause usually begins in the forties and can last years before periods stop. It is real, it is treatable, and you should not have to white knuckle through it. SheWellRX offers thirty minute video visits with a board certified ObGyn who has treated menopause for more than thirty five years, for women anywhere in New Jersey.",
    symptoms: [
      ...
      "Weight that shifts to the middle",
    ],
    whatWeDo: [
      {
        title: "A real history, not a checklist",
        body: "Your intake asks about your cycle, your symptoms and how much they bother you, and the conditions that decide which treatments are safe. Dr. Copur reads it before the visit, so the thirty minutes are spent on you.",
      },
      {
        title: "Diagnosis by the story, labs only when they change the plan",
      ...
      },
      {
        ...
        body: "Menopausal hormone therapy relieves hot flashes and night sweats better than any other treatment, and it is safe for many women when started at the right time. If it is not right for you, non hormonal medications and vaginal estrogen still help. The plan is written, and it is yours to keep.",
      },
      {
        title: "Follow up that does not disappear",
        body: "Two weeks of messaging come with every visit, and follow ups are $149. Doses are adjusted, side effects are managed, and your plan is reviewed rather than set and forgotten.",
      },
    ],
    prescribe: [
    ...
    inPerson: [
      ...
      "Any concern that needs an exam, ultrasound, or biopsy; we refer you and your records follow",
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Usually not. Hormone levels fluctuate widely in perimenopause, so a single blood test rarely changes the plan. Dr. Copur orders labs when they would change a decision, for example to rule out thyroid disease or anemia.",
      },
      {
        q: "Is hormone therapy safe?",
        a: "For many women who start within about ten years of their last period and before sixty, and who have no history of breast cancer, blood clots, stroke, or liver disease, the benefits outweigh the risks. Transdermal estradiol carries a lower clot risk than pills. Your history decides, and the conversation is honest.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes. Dr. Copur is licensed in New Jersey, and telehealth law follows where the patient is during the visit, so you need to be physically in the state at the time of your video visit. You can live anywhere in New Jersey.",
      },
    ],
  ...
  },
  {
    ...
    h1: "Hormone therapy, decided with a specialist, not a headline",
    eyebrow: "Hormone therapy · New Jersey telehealth",
    intro:
      "Hormone therapy has been argued about in the news for twenty years. What you need is not a headline, it is a doctor who knows the evidence and your chart. Started at the right dose for the right patient, menopausal hormone therapy can change daily life. SheWellRX starts, adjusts, and reviews hormone therapy by video for women across New Jersey, and gives second opinions when you were told no without a real conversation.",
    symptoms: [
      "Hot flashes or night sweats that disrupt work or sleep",
      "Symptoms that came back after stopping hormones",
      "A prescription that never felt right and was never adjusted",
      "Told you cannot take hormones, without being told why",
      "Early menopause or surgical menopause before forty five",
      "Vaginal dryness that moisturizers do not fix",
    ],
    whatWeDo: [
      {
        title: "Screen for the conditions that matter",
        body: "Breast, uterine, or ovarian cancer, blood clots, stroke or heart attack, migraine with aura, liver disease, unexplained bleeding, and smoking are the history that shapes the choice. The intake asks every one of them, and Dr. Copur reviews it before you meet.",
      },
      {
      ...
      },
      {
        ...
        body: "Relief of hot flashes, better sleep, protection against bone loss, and treatment of vaginal symptoms on one side; small increases in clot, stroke, and breast cancer risk that depend on age, timing, type, and your history on the other. You leave with the numbers that apply to you, not a slogan.",
      },
      {
        title: "Review, do not set and forget",
    ...
    faq: [
      {
        ...
        a: "Yes. Estradiol and progesterone are not controlled substances. After a live video visit in which Dr. Copur reviews your history and confirms the treatment is appropriate, the prescription is sent electronically to your pharmacy. New Jersey law does not allow prescribing from a questionnaire alone, and neither do we.",
      },
      {
        q: "Is compounded or bioidentical hormone therapy better?",
        a: "FDA approved estradiol and micronized progesterone are themselves bioidentical, and they come in tested doses. Compounded pellets and creams are not FDA approved and do not have reliable dosing, so we start with approved products. If there is a specific reason to compound, we discuss it honestly.",
      },
      {
  ...
  },
  {
    ...
    h1: "Birth control prescribed online, matched to your body and your plans",
    ...
    symptoms: [
      ...
      "Renewing a prescription without a waiting room",
      "Wanting fewer or no periods",
    ...
    whatWeDo: [
      ...
      {
        title: "Refer for what needs hands on care",
  ...
  },
  {
    ...
    h1: "Heavy, painful, or unpredictable periods deserve answers, not a shrug",
    eyebrow: "Periods and PCOS · New Jersey telehealth",
    intro:
      "A period that floods through protection, cramps that cancel plans, cycles that vanish for months, or a PCOS diagnosis that came with no plan. Your cycle is a vital sign, and when it changes, something is being said. A video visit with a board certified ObGyn is a structured evaluation: the pattern, the causes that need ruling out, the tests that would change the answer, and a plan you can start.",
    symptoms: [
      ...
      "Cramps that do not respond to over the counter medicine",
      "Acne, excess hair growth, or scalp hair thinning with irregular cycles",
    ],
    whatWeDo: [
      {
        title: "Map the pattern",
        body: "How often, how heavy, how long, and since when. The intake collects a bleeding history so the visit starts with the facts rather than a rushed recap.",
      },
      {
        title: "Rule out what must be ruled out",
      ...
      {
        title: "Say plainly when in person care is needed",
    ...
    faq: [
      {
        ...
        a: "Often, yes. The diagnosis rests on cycle history, signs of excess androgens, and, when needed, labs and an ultrasound that can be ordered from a video visit and done near your home. Dr. Copur reviews the results with you and builds the plan.",
      },
      {
      ...
      },
      {
        ...
        a: "Bleeding that soaks protection every hour for two hours or more, fainting, or severe pain with fever needs the emergency room, not a video visit. Otherwise a visit this week is the right next step.",
      },
      {
        q: "What does it cost?",
  ...
  },
  {
    ...
    concern: "intimacy",
    name: "Vaginal dryness, painful sex, and low desire",
    title: "Vaginal Dryness and Painful Sex Treatment in NJ | SheWellRX",
    description:
      "Vaginal dryness, pain with sex, and low desire treated by video in New Jersey. Vaginal estrogen and comfort care from a board certified ObGyn, in private.",
    h1: "Dryness, pain, and low desire are medical concerns, not embarrassments",
    eyebrow: "Sexual health · New Jersey telehealth",
    intro:
      "Dryness, burning, pain with intimacy, recurrent urinary symptoms, or desire that faded and never came back. These are medical issues with medical answers, and they deserve the same seriousness as any other diagnosis. A video visit means a private conversation from your own home with a board certified ObGyn, and treatment that can start this week.",
    symptoms: [
      "Vaginal dryness, itching, or burning",
      "Pain at entry or deep pain with sex",
      "Bleeding or tearing with intimacy",
      "Urgency, frequency, or repeated urinary infections after menopause",
      "Low desire that bothers you",
    ...
    whatWeDo: [
      ...
      },
      {
        ...
        body: "Low dose vaginal estrogen, as a cream, tablet, or ring, restores the tissue with minimal absorption into the body and is considered safe for most women, including many with a history of breast cancer after discussion with their oncologist. Moisturizers and lubricants that actually help are part of the plan.",
      },
      {
        title: "Address desire honestly",
    ...
    faq: [
      {
        ...
        a: "Yes. After a live video visit and a review of your history, Dr. Copur can prescribe vaginal estrogen, which is sent electronically to your pharmacy. It is a local, low dose treatment that most women can use safely.",
      },
      {
        q: "I had breast cancer. Are there options?",
        a: "Often, yes. Non hormonal moisturizers and lubricants come first, and low dose vaginal estrogen is used by many survivors after a conversation with their oncologist. We coordinate with your cancer team rather than guess.",
      },
      {
